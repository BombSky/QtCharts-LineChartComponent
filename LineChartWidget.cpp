...
void LineChartWidget::SetXAxisQDateTimeType()
{
    ...
    (
        QDateTime::fromString("00:00", *pTimeFormat),
        QDateTime::fromString("00:20", *pTimeFormat)
    );
    pXaxisStyle->setFormat(*pTimeFormat);
    qDebug() << *pTimeFormat;
    XAxisQDateTimeAdaptive(QDateTime::fromString("00:00", *pTimeFormat ).toMSecsSinceEpoch());
}
